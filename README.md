...
1. When we have multiple instances of asame module in a design, so synthesize this single design and replicate it multiple times in the top module this saves time and synthesizer effor.
2. We want to employ divide and conquer approach in case of massive designs.<br> 
#### Flat Synthesis
